...
export default function AdminStorageError({
  error,
  reset,
}: {
    ...
    <ErrorBoundary>
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Storage Error</h2>
          <p className="text-on-surface-variant text-sm mb-6">
            {error.message || 'Failed to load storage manager. Please try again.'}
          </p>
          {error.digest && (
